...
-- Quiz 1
insert into ASC_QUESTION values (1, 'Heureusement, le phénomène naturel de l effet de serre conserve dans l atmosphère une partie de la chaleur du soleil !', 1, 'A' , 'Quelle serait la température de la Terre sans atmosphère ?',1);
...
insert into ASC_QUESTION values (2,'La vapeur d eau contribue pour 60 % à l effet de serre. Les émissions de ce gaz par l humanité à travers l industrie n ont cependant qu un effet limité car la durée de vie de la vapeur d eau est courte.',1,'B', 'Quel gaz a l effet de serre le plus puissant ?',2);
-- Options de la question
...
insert into ASC_QUESTION values (3, 'Plus de 50% est encore absorbé par l atmosphère.', 1,'A','Où va la majorité du CO2 émis par l Homme ?',3);
-- Options de la question
...
insert into ASC_QUESTION values (4, 'À quantité égale, produire une tomate en hiver génère aujourd hui plus de C02 que le transport des autres aliments...', 1,'B','En hiver et à quantité égale, lequel de ces aliments émet le plus de CO2 ?',4);
-- Options de la question
...
-- Quiz 2
insert into ASC_QUESTION values (5, 'Le GEIC a bien été crée en 1988', 2 ,'A','En quelle année le GEIC a été crée ?',1);
