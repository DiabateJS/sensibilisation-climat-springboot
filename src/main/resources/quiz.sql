...
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('A','+15 °C',1);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('B','0 °C',1);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('C','-50 °C',1);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('D','-18 °C',1);
...
-- Options de la question
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('A','CO2',2);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('B','Vapeur d eau',2);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('C','Méthane',2);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('D','Argon',2);
...
-- Options de la question
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('A','Dans l atmosphère',3);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('B','Dans l océan',3);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('C','Méthane',3);
...
-- Options de la question
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('A','Banane de Martinique',4);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('B','Tomates d Espagne',4);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('C','Le rutabaga picard',4);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('C','Le café colombien',4);
...
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('A','1988',5);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('B','1999',5);
insert into ASC_OPTION(idOption, valeur, idQuestion) value ('C','2005',5);